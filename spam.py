...
Write.Print('Bản Quyền: Ma Văn Nam '+'\n' ,Colors.red_to_yellow, interval=0.005)
Write.Print('Zalo: 0964959134 '+'\n' ,Colors.red_to_yellow, interval=0.005)
Write.Print('Facebook: https://www.facebook.com/MA.Văn.Nam.Info '+'\n' ,Colors.red_to_yellow, interval=0.005)
Write.Print('==========================================================================='+'\n' ,Colors.red_to_yellow, interval=0.005)
